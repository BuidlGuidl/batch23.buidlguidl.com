...
const ShivamPage: NextPage = () => {
  ...
  const bgGradient = isDark ? "from-slate-950 via-purple-950 to-slate-950" : "from-blue-50 via-purple-50 to-pink-50";
  ...
  return (
    <div
      className={`relative min-h-screen bg-gradient-to-br ${bgGradient} py-12 px-4 overflow-hidden transition-colors duration-500`}
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        {/* Main Content */}
        <div
          className="glass-card rounded-b-3xl p-8 md:p-12 relative overflow-hidden shadow-2xl"
        ...
        >
          ...
          >
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <div className="inline-block glass-card px-6 py-4 rounded-2xl border-2 border-cyan-500/40 mb-4 hover:border-cyan-400/60 transition-all duration-300 hover:scale-105 shadow-xl hover:shadow-cyan-500/30">
                <div className="text-cyan-400 text-xs terminal-text mb-2 opacity-70 font-bold tracking-widest">
                  0x ADDRESS:
                </div>
          ...
          {/* Bio Section */}
          <div
            className="glass-card rounded-2xl p-8 mb-8 border-2 border-purple-500/30 relative overflow-hidden group hover:border-purple-400/50 transition-all duration-300 shadow-xl"
              ...
              <div className="relative z-10">
                ...
                <div className="space-y-5 terminal-text text-sm">
                  {[
                    ...
                    <div
                      key={idx}
                      className="flex items-start gap-4 group/item hover:translate-x-3 transition-all duration-300 p-3 rounded-lg hover:bg-white/5"
                    >
                      <span className={`${item.color} mt-1 text-2xl group-hover/item:scale-125 transition-transform`}>
                        {item.icon}
                      </span>
          ...
          <div className="glass-card rounded-2xl p-8 border-2 border-green-500/30 mb-8 relative overflow-hidden group hover:border-green-400/50 transition-all duration-300 shadow-xl">
            ...
            <div className="relative z-10">
              ...
              <blockquote
                className={`${textPrimary} italic border-l-4 border-cyan-500 pl-6 mb-10 text-xl leading-relaxed font-medium bg-gradient-to-r from-cyan-500/5 to-transparent py-4 rounded-r-lg`}
              >
          ...
          <div
            className={`terminal-text ${textSecondary} text-sm text-center pt-6 border-t-2 border-slate-700/50 dark:border-slate-600/50 font-medium`}
          >
